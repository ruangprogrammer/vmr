...
<form method="POST" action="update-member.php" enctype="multipart/form-data">
	<input type="hidden" name="id" value="<?php echo $dataMember['siswa_id']; ?>">
				...
				<div class="column">
					...
					<div>
						<figure>
							...
							<br>
							<input type="file" name="siswa_images">
						</figure>
					</div>
				</div>	
			</p>
...
<div class="col-lg-9">
			...
			<table border="0">
				...
				<tr>
				<td>Nama </td><td>:</td><td><input  type="text" name="siswa_name" value="<?php echo $dataMember['siswa_name'];?>" class="form-control"></td>
				</tr><tr><td>&nbsp</td></tr>
				<tr>
				<td>Email </td><td>:</td><td><input name="frm_email" type="text" value="<?php echo $dataMember['member_email']; ?>" class="form-control" disabled></td>
				</tr><tr><td>&nbsp</td></tr>
				<tr>
				<td>Username </td><td>:</td><td><input name="frm_username" type="text" value="<?php echo $dataMember['member_username']; ?>" class="form-control" disabled></td>
				</tr><tr><td>&nbsp</td></tr>
				<tr>
				<td>Password </td><td>:</td><td>*******************</td>
				</tr><tr><td>&nbsp</td></tr>
				<tr>
				<td>Kota</td><td>:</td><td><input name="siswa_city" type="text" value="<?php echo $dataMember['siswa_city']; ?>" class="form-control"></td>
				</tr><tr><td>&nbsp</td></tr>
				<tr>
				<td>lamat Lengkap</td><td>:</td><td>
					<textarea class="form-control" name="siswa_address"><?php echo $dataMember['siswa_address']; ?></textarea>
