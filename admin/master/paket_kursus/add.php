...
if (isset($_POST['simpan'])) {   //print_r($_FILES); exit();
    if (!empty($_FILES) && $_FILES['paket_kursus_images']['size'] > 0 && $_FILES['paket_kursus_images']['error'] == 0) {
        ...
        if ($move) {
            $queryInsert = mysql_query("INSERT INTO paket_kursus SET 
                         paket_kursus_name='" . $_POST['paket_kursus_name'] . "',
                         paket_kursus_images='" . $images . "',
                         paket_kursus_price ='".$_POST['paket_kursus_price']."',
                         paket_kursus_desc='".$_POST['paket_kursus_desc']."',
                         paket_kursus_date=NOW()");
        } else {
            $queryInsert = mysql_query("INSERT INTO paket_kursus SET 
                         paket_kursus_name='" . $_POST['paket_kursus_name'] . "',
                         paket_kursus_price='".$_POST['paket_kursus_price']."',
    ...
    if ($queryInsert) {
        echo "<script> alert('Data Berhasil Disimpan'); location.href='index.php?hal=master/paket_kursus/list' </script>";
        exit;
    }
}
                    ...
                    <div class=" form">
                        <form class="cmxform form-horizontal adminex-form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-5">
                                    <input class=" form-control" id="cname" name="paket_kursus_name" minlength="2"
                                           type="text" required/>
                                </div>
                            </div>
                                ...
                                <div class="col-md-5">
                                    <div class="fileupload fileupload-new" data-provides="fileupload"><input
                                        ...
                                        <div>
                                                   ...
                                                   <input type="file" name="paket_kursus_images" class="default">
                                                   </span>
                            ...
                            <div class="form-group ">
                                    ...
                                    <div class="col-lg-5">
                                        <input class="form-control" id="cname" name="paket_kursus_price"  type="text" required="" />
                                    </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <label for="cname" class="control-label col-lg-2" style="text-align: left;">Nama</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control ckeditor" id="cname" name="paket_kursus_desc" ></textarea>
                                </div>
                            </div>
