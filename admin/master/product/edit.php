...
$rowProduct = mysql_fetch_array($queryRowProduct);
    if (isset($_POST['ubah'])) {  
      if (!empty($_FILES) && $_FILES['product_images']['size'] >0 && $_FILES['product_images']['error'] == 0){  
            $random = "vmrmekanikberdasi-product-".substr(number_format(time() * rand(), 0, '', ''), 0, 10);
            $images = $random . str_replace(" ", "", $_FILES['product_images']['name']);
            $move = move_uploaded_file($_FILES['product_images']['tmp_name'],'../images/product/'.$images);  
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" enctype="multipart/form-data"  action="">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-5">
                                            <img src="../images/product/<?php echo $rowProduct['product_images']; ?>" width="50%">
