...
if (isset($_POST['simpan'])) {   //print_r($_FILES); exit();
    if (!empty($_FILES) && $_FILES['about_images']['size'] > 0 && $_FILES['about_images']['error'] == 0) {
        ...
        if ($move) {
            $queryInsert = mysql_query("INSERT INTO about SET 
    ...
    if ($queryInsert) {
        echo "<script> alert('Data Berhasil Disimpan'); location.href='index.php?hal=master/about/list' </script>";
        exit;
    }
}
                    ...
                    <div class=" form">
                        <form class="cmxform form-horizontal adminex-form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-5">
                                    <input class=" form-control" id="cname" name="about_name" minlength="2"
                                           type="text" required/>
                                </div>
                            </div>
                                ...
                                <div class="col-md-5">
                                    <div class="fileupload fileupload-new" data-provides="fileupload"><input
                                        ...
                                        <div>
                                                   ...
                                                   <input type="file" name="about_images" class="default">
                                                   </span>
                            ...
                            <div class="form-group ">
                                <label for="cname" class="control-label col-lg-2" style="text-align: left;">Nama</label>
                                <div class="col-lg-5">
                                    <textarea class=" form-control" id="cname" name="about_desc" ></textarea>
                                </div>
                            </div>
