...
if (isset($_GET['hapus'])) {
    ...
    if(!empty($data['artikel_images'])){
        $file = "assets/images/artikel/".$data['artikel_images'];
        unlink($file);
    }
                    ...
                    <div class="adv-table editable-table ">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            while ($rowartikel = mysql_fetch_array($queryPortofolio)) {
                                ?>
                                <tr class="">
                                    <td><img src="assets/images/artikel/<?php echo $rowartikel['artikel_images']; ?>"
                                             width="100%"></td>
                                    <td><?php echo $rowartikel['artikel_name'] ?></td>
                                    <td><?php echo substr($rowartikel['artikel_desc'],0,150); ?>.....</td>
