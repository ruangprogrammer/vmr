...
$rowartikel = mysql_fetch_array($queryRowartikel);
    if (isset($_POST['ubah'])) {  
      if (!empty($_FILES) && $_FILES['artikel_images']['size'] >0 && $_FILES['user_foto']['error'] == 0){  
          $random = "vmrmekanikberdasi-testimoni-".substr(number_format(time() * rand(), 0, '', ''), 0, 10);
            ...
            $move = move_uploaded_file($_FILES['artikel_images']['tmp_name'],'assets/images/artikel/'.$images);  
            ...
            if ($move) {  
                $queryUpdate  = mysql_query("UPDATE artikel SET 
                                    ...
                                    WHERE artikel_id     = '".$id."'
                                     ");
                $file = "assets/images/artikel/".$rowartikel['artikel_images'];
                unlink($file);
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" enctype="multipart/form-data"  action="">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-5">
                                            <img src="assets/images/artikel/<?php echo $rowartikel['artikel_images']; ?>" width="50%">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-5">
                                            <textarea class="form-control " id="ccomment" name="artikel_desc" required><?php echo $rowartikel['artikel_desc']; ?></textarea>
                                        </div>
                                    </div>
