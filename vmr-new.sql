...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2017 at 06:17 AM
...
INSERT INTO `member` (`member_id`, `member_email`, `member_username`, `member_password`) VALUES
(1, 'member@yahoo.com', 'admin', '$2y$10$DlmbzphG8R0/jKJS5mzS5e.NvitZtMRnaDeCcVHN8q1NbyN3m3V/C');
...
INSERT INTO `siswa` (`siswa_id`, `siswa_code`, `siswa_images`, `siswa_name`, `siswa_address`, `siswa_city`, `siswa_status`, `member_id`) VALUES
(5, '1344', 'vmrmekanikberdasi-siswa-2029022568foto.jpg', 'Dina Putri Utami', 'Bantul City', 'Yogyakarta', 'lulus', 1),
(6, '2323', 'vmrmekanikberdasi-siswa-1534504715v.jpg', 'Arum Kartika Devi', 'Sleman', 'Sleman', 'lulus', NULL),
(7, '123', 'vmrmekanikberdasi-siswa-1481520501Screenshot_1.jpg', 'Puji Waloyo', 'Jln Tamrin Raya jakarta Selatan', 'Jakarta', 'belum_lulus', NULL);
